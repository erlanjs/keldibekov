                ...
                <div className="footer-general">
                    ...
                    <div>
                        ...
                        <div className="footer-general__contact" style={{paddingTop: media(10, 40)}}>
                            ...
                            <a href="tel:0 (552) 61 55 19">0 (552) 61 55 19</a>
                        </div>
                    </div>
                    <div className="footer-general__center">
                        <a href="#">zhamiliya.73@mail.ru</a>
                        {/*<div>*/}
                        {/*    <h1>Developed at</h1>*/}
                        {/*    <img src={motion} alt=""/>*/}
                    ...
                    <div className="footer-general__seti">
                        <h1>Соц тармактар</h1>
                        <span><a href="https://wa.me/0552-61-55-19"><i className="fab fa-whatsapp"/></a></span>
                        <span><a href="https://t.me/0552-61-55-19"><i className="fab fa-telegram"/></a></span>
